...
//webEnvironment = SpringBootTest >> Sobe a parte web do spring e permitando assim as requisicoes http
public class CarroAPITest {
    @Autowired
    protected TestRestTemplate rest; // efetua as requisicoes http
